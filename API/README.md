...
| Tabla | Descripción |
|-------|-------------|
| **Presupuestos** | Almacena los presupuestos mensuales por categoría |
| **Gastos** | Registro de gastos individuales vinculados a presupuestos |
| **GastosFijos** | Gastos recurrentes anuales con mes de cobro específico |
| **Usuarios** | Gestión de usuarios (futuro) |

### Relaciones
- Un Presupuesto tiene múltiples Gastos
- Un Presupuesto puede tener múltiples GastosFijos
- Un Usuario tiene múltiples Presupuestos
