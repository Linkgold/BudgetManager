...
namespace Application.Services
{
    ...
    public class TransactionService : ITransactionService
    {
        ...
        public async Task<List<TransactionResponseDTO>> GetByCategoryIdAsync(int categoryId)
        {
            ...
            IEnumerable<Transaction> transactions = await _transactionRepository.GetByCategoryIdAsync(categoryId);
        ...
        public async Task<List<TransactionResponseDTO>> GetByMonthlyPeriodAsync(int month, int year)
        {
            ...
            IEnumerable<Transaction> transactions = await _transactionRepository.GetByMonthlyPeriodAsync(period);
        ...
        public async Task<List<TransactionResponseDTO>> GetByCategoryAndMonthlyPeriodAsync(int categoryId, int month, int year)
        {
            ...
            MonthlyPeriod period = new MonthlyPeriod(month, year);
            IEnumerable<Transaction> transactions = await _transactionRepository.GetByCategoryAndMonthlyPeriodAsync(categoryId, period);
        ...
        public async Task<List<TransactionResponseDTO>> GetByDateRangeAsync(DateTime from, DateTime to)
        {
            ...
            IEnumerable<Transaction> transactions = await _transactionRepository.GetByDateRangeAsync(startDate, endDate);
        ...
        public async Task<decimal> GetTotalByCategoryAndMonthlyPeriodAsync(int categoryId, int month, int year)
        {
            ...
            MonthlyPeriod period = new MonthlyPeriod(month, year);
            return await _transactionRepository.GetTotalByCategoryAndMonthlyPeriodAsync(categoryId, period);
        }
        ...
        public async Task<TransactionResponseDTO> CreateAsync(CreateTransactionRequestDTO request)
        {
            ...
            Transaction transaction = new Transaction(category, info, amount, request.Type, date);
        ...
        public async Task DeleteAsync(int id)
        {
            ...
            if (!await _transactionRepository.ExistsAsync(id)) throw new KeyNotFoundException($"Transaction with ID {id} not found");
