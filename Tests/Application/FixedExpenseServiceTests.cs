...
namespace Tests.Application
{
    ...
    public class FixedExpenseServiceTests : IDisposable
    {
        ...
        public async Task CreateAsync_WithValidData_ReturnsCreatedFixedExpense()
        {
            ...
            // Act
            FixedExpenseResponseDTO result = await _fixedExpenseService.CreateAsync
            (
                new CreateFixedExpenseRequestDTO
                {
        ...
        public async Task UpdateAsync_WithValidData_ReturnsUpdatedFixedExpense()
        {
            ...
            // Act
            FixedExpenseResponseDTO result = await _fixedExpenseService.UpdateAsync
            (
                fixedExpenseId,
        ...
        public async Task UpdateAsync_WithNonExistingId_ThrowsKeyNotFoundException()
        {
            ...
            // Act & Assert
            await Assert.ThrowsAsync<KeyNotFoundException>(() => _fixedExpenseService.UpdateAsync(fixedExpenseId, new UpdateFixedExpenseRequestDTO()));
        ...
        public async Task DeleteAsync_WithExistingId_DeletesFixedExpense()
        {
            ...
            // Assert
            _fixedExpenseRepositoryMock.Verify(repo => repo.DeleteAsync(userId, fixedExpenseId), Times.Once);
        }
